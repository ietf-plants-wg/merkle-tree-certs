...
var (
	...
	flagConfig = generateFlags.String("config", "mtc.json", "the path to the config file to generate certificates from")
	flagOutDir = generateFlags.String("out", "out", "the path to the output directory")
)
